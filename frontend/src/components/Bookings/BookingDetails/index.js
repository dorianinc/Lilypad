...
const BookingDetails = () => {
  ...
  const formattedStartDate = format(addDays(new Date(booking.startDate), 1), "EE, MMM do");
  const formattedEndDate = format(addDays(new Date(booking.endDate), 1), "EE, MMM do");
  return (
