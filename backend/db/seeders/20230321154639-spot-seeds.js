...
const spotSeeds = () => {
  return [
    ...
    },
    {
      ...
      lat: 37.7749,
      lng: -122.4194,
      description: "Welcome to the dynamic city of San Francisco! This elegant and spacious apartment offers a comfortable and convenient stay in the heart of the city. With its prime location, modern amenities, and stunning views, it's the perfect base for exploring the city's iconic landmarks, vibrant neighborhoods, and world-class dining scene. Immerse yourself in the unique culture and energy of San Francisco!",
      price: 450,
      minNights: 3,
      maxGuests: 8,
      ownerId: 9
